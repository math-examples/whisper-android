...
class WhisperContext private constructor(private var ptr: Long) {
    ...
    // Updated: Add prompt parameter (nullable, default to null)
    suspend fun transcribeData(
        ...
        // Updated: Pass prompt to fullTranscribe (null if not provided)
...
private class WhisperLib {
    companion object {
        ...
        // JNI methods (updated: add prompt to fullTranscribe)
        external fun initContextFromInputStream(inputStream: InputStream): Long
        external fun initContextFromAsset(assetManager: AssetManager, assetPath: String): Long
        external fun initContext(modelPath: String): Long
        external fun freeContext(contextPtr: Long)
        external fun fullTranscribe(contextPtr: Long, numThreads: Int, audioData: FloatArray, prompt: String?) // Updated
